...
})({"8HHum":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "2e23b082ebb10a43";
"use strict";
...
class View {
    ...
    insertModalHTML(modelFromModal) {
        ...
        const html = `
        <div class="modal">
            <div class="exit-modal">\u{2716}</div>
        ...
        document.querySelector(".exit-modal").addEventListener("click", this.modalExit.bind(this));
        document.addEventListener("keydown", (e)=>{
