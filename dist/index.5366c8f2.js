...
})({"cPSOK":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "8c8e28225366c8f2";
"use strict";
...
},{}],"aS8Tu":[function(require,module,exports) {
...
const spawnBooks = async function() {
    try {
        ...
        (0, _viewJsDefault.default).insertBooksHTML(books);
    } catch (err) {
...
const spawnModal = async function() {
    ...
    const modalData = await _modelJs.getModalData(id);
    (0, _viewJsDefault.default).insertModalHTML(modalData);
};
const init = function() {
...
//# sourceMappingURL=index.5366c8f2.js.map
